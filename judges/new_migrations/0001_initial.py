    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('judge_type', models.CharField(blank=True, max_length=30, null=True, verbose_name='Judge Type', choices=[(None, 'Unknown'), (b'research', 'Research'), (b'primary', 'Primary'), (b'appeal', 'Appeal'), (b'supreme', 'Supreme')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_type', models.CharField(max_length=16, choices=[(b'rulings', 'Rulings'), (b'verdicts', 'Verdicts'), (b'transcripts', 'Transcripts'), (b'campaigns', 'Campaigns')])),
                ('created_by', models.ForeignKey(related_name='+', default=core_types.utils.get_request_user, blank=True, to=settings.AUTH_USER_MODEL, null=True, verbose_name='Created By')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timeline_is_estimate', models.NullBooleanField(verbose_name='Timeline Date Is Estimate?')),
                ('source_link', models.CharField(max_length=255, null=True, verbose_name=b'Source Link', blank=True)),
